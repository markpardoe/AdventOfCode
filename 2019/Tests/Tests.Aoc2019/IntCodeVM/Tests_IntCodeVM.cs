...
namespace AoC.AoC2019.Tests.IntCodeVM
{
    ...
    {       
        ...
        {
            IVirtualMachine parser = new Aoc.AoC2019.IntCode.IntCodeVM(input);
            parser.Execute();
        ...
        {
            Aoc.AoC2019.IntCode.IntCodeVM parser = new Aoc.AoC2019.IntCode.IntCodeVM(input);
            parser.Execute();
        ...
        {
            Aoc.AoC2019.IntCode.IntCodeVM parser = new Aoc.AoC2019.IntCode.IntCodeVM(values, input);
            parser.Execute();
        ...
        {
            Aoc.AoC2019.IntCode.IntCodeVM parser = new Aoc.AoC2019.IntCode.IntCodeVM(values);
            parser.Execute();
