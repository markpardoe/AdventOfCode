...
namespace AoC.AoC2019.Tests.Day22
{
    public class Day22Tests : AocSolutionTest<string>
    {
        protected override SolutionData<string> Solution => new SolutionData<string>(new Day22_Solution(), "4096", "78613970589919");
